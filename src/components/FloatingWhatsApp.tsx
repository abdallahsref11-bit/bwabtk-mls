...
export function FloatingWhatsApp() {
  ...
  return (
    <div className="fixed bottom-6 left-6 z-40 flex flex-col items-start gap-2 dir-rtl">
      ...
      {/* Tooltip notice */}
      {showTooltip && (
        <div className="relative bg-slate-900 border border-emerald-500/40 text-white text-xs font-semibold px-3.5 py-2 rounded-2xl shadow-2xl flex items-center gap-2 max-w-xs animate-bounce">
          <span>👋 تواصل مباشر معنا عبر الواتساب: +601128778837</span>
          <button
