...
export const UNIVERSITIES_DATA: University[] = [
  {
    ...
    tuitionPerYearUsd: 2400,
    durationYears: '3 سنوات فقط',
    highlightOffer: 'فرصة استثنائية: بكالوريوس ذكاء اصطناعي وأمن سيبراني وأي تخصص تقني بـ 2,400$ فقط للسنة وعلى مدار 3 سنوات!',
    specialties: ['الذكاء الاصطناعي (AI)', 'الأمن السيبراني (Cyber Security)', 'تكنولوجيا المعلومات (IT)', 'إدارة الأعمال', 'الهندسة'],
    descriptionAr: 'جامعة معترف بها بتصنيف QS مميز، تقدم جميع التخصصات التقنية كالذكاء الاصطناعي والأمن السيبراني في ثلاث سنوات فقط بسعر استثنائي ومنافس يبلغ حوالي 2,400 دولار في السنة. فرصة ممتازة للحصول على شهادة بكالوريوس معتمدة.',
